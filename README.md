...
Die folgenden Extrakte wurden lokal erzeugt und in `source_extracts/` abgelegt:

- `kultur_pandemie_linksammlung.txt`
- `kultur_pandemie_linksammlung_erweitert.txt`
- `kultur_pandemie_sammlung3.txt`
- `kultur_pandemie_sammlung4.txt`
- `school_at_home.txt`
